...
const ResultsPage = () => {
  ...
  const resultsData = [
    { candidate: 'Charles Ngandwe', percentage: 58.67, votes: 56783 },
    { candidate: 'Jane Chimwembe', percentage: 30.25, votes: 29345 },
    { candidate: 'Manyambe Mubita', percentage: 11.08, votes: 10784 },
  ];
  ...
  return (
    <div className="px-4 py-30">
      <HorizontalNav/>
      <h1 className="text-2xl text-black font-semibold mb-4">2024 Presidential Election Results</h1>
