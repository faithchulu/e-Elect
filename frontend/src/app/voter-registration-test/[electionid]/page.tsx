...
const VoterRegistrationForm = () => {
  ...
  const handleChange = (
    ...
    if (name === "province") {
      setFilteredConstituencies(constituenciesByProvince[value as Province] || []);
  ...
  return (
    <div className="relative min-h-screen">
      <div className="absolute inset-0">
        <Image src={VoteBG} alt="Vote Background" layout="fill" objectFit="cover" quality={100} />
      ...
      <div className="relative z-10 min-h-screen px-4 py-30">
        ...
        <div className="mx-auto mt-8 max-w-md rounded-lg border bg-white p-6 shadow-lg">
          <h2 className="mb-4 text-xl font-semibold text-black">Voter Registration Form</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 3 && (
              <>
                <div className="mb-4">
                  <label htmlFor="residentialAddress" className="text-gray-700 block text-sm font-medium">Residential Address</label>
                  <textarea
                ...
                <div className="mb-4">
                  <label htmlFor="province" className="text-gray-700 block text-sm font-medium">Province</label>
                  <select
                    id="province"
                    name="province"
                ...
                <div className="mb-4">
                  <label htmlFor="constituency" className="text-gray-700 block text-sm font-medium">Constituency</label>
                  <select
                    id="constituency"
                    name="constituency"
